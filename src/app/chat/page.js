  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col overflow-hidden">
      ...
      <main className="flex-1 overflow-hidden">
        <section className="w-full mx-0 px-0 py-0 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full h-[calc(100vh-5rem)] overflow-hidden px-2 md:px-6">
            {/* Chat */}
            <div className="border border-slate-100 rounded-lg p-2 h-full flex flex-col">
              ...
              <div className="flex-1 rounded-md border-2 border-dashed border-slate-100 bg-white flex items-center justify-center text-slate-400 p-6">
